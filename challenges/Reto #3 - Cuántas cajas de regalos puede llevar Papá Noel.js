...
que recibe una caja de regalos y una lista de renos y devuelve el número máximo de cajasde estos
...
function distributeGifts(packOfGifts, reindeers) {
  ...
  const countGiftChars = howManyChars(packOfGifts)
  const countReindeersChars = howManyChars(reindeers) * 2
  
  return Math.floor(countReindeersChars / countGiftChars)
}